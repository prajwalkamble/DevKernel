...
`,
    ...
    },
    {
      ...
      body: [
        ...
        "The bounds are worth measuring rather than trusting. Over twenty thousand random instances the half guarantee is never violated — the worst case seen is 0.5652 — and the fractional bound lands within ten percent of the optimum just under two thirds of the time. It can also be terrible: when one heavy item dominates and nothing else fits, the relaxation is over six times the achievable value. A bound is only useful if you know when it is loose.",
      ],
      examples: [
        {
