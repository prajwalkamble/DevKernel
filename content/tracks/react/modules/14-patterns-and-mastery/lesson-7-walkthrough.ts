...
after typing "z":  expanded=true options=1 active=Brazil`,
    ...
    },
    {
      ...
      body: [
        ...
        "That is the shape of every senior decision in this module. Know the mechanism, build it when you need to, and be able to say when not to. The module that follows is that judgement applied end to end: one complete project — an issue tracker — specified before a line of it is built.",
      ],
    },
  ],
  interviewQuestions: [
